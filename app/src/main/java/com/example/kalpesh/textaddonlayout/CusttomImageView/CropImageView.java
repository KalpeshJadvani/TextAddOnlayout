...
import com.example.kalpesh.textaddonlayout.R;
...
public class CropImageView extends ImageView {
    ...
    public static RectF mImageRect_setin_screchview;
    ...
    public int CropImgaeViewWidth(){
       return mViewWidth;
    }
    public int CropImgaeViewHeight(){
        return mViewHeight;
    }
    ...
    private void setupLayout(int viewW, int viewH) {
        ...
        mImageRect_setin_screchview=mImageRect;
        mIsInitialized = true;
        invalidate();
        ...
        if (mIsAnimationEnabled) {
            ...
            animator.addAnimatorListener(new SimpleValueAnimatorListener() {
                ...
                public void onAnimationFinished() {
                    ...
                    mScale = newScale;
                    setupLayout(mViewWidth, mViewHeight);
                    setImageBitmap(RotateBitmap(getBitmap(),mAngle));
                    mIsRotating = false;
                }
            });
            animator.startAnimation(durationMillis);
